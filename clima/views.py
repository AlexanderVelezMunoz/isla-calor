# Archivo views.py corregido para Railway sin cambiar la lógica del mapa
...
def generar_mapa(request):
    # === CARGA DE ARCHIVOS ===
    excel_path   = os.path.join(settings.BASE_DIR, "temperaturas_rellenas_promedio.xlsx")
    limite_path  = os.path.join(settings.BASE_DIR, "medellin_comunas_corregimientos.geojson")
    comunas_path = os.path.join(settings.BASE_DIR, "medellin_comunas_corregimientos.geojson")
    vecinos_path = os.path.join(settings.BASE_DIR, "municipios_vecinos.geojson")
    ...
    # === LOGOS: búsqueda flexible ===
    logo_rutas = [
        os.path.join(settings.BASE_DIR, "media", "static", "logos", "logo_instituto.png"),
        os.path.join(settings.BASE_DIR, "media", "static", "logos", "logo_universidad.png"),
        os.path.join(settings.BASE_DIR, "static", "logos", "logo_instituto.png"),
        os.path.join(settings.BASE_DIR, "static", "logos", "logo_universidad.png"),
    ]
    ...
    fig.suptitle(f"ISLA DE CALOR URBANA SUPERFICIAL\nMedellín – {meses_name[mes-1]} {anio}", fontsize=13, weight='bold')
